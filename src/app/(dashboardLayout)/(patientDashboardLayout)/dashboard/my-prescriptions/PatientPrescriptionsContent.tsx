...
import { FileText, Stethoscope, Calendar, Eye, Printer, Download } from "lucide-react";
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 p-4 bg-muted/50 rounded-lg">
            ...
            <div>
              <h3 className="font-semibold">Dr. {prescription.doctor?.name}</h3>
              <p className="text-sm text-muted-foreground">
                {prescription.doctor?.designation}
              </p>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-muted-foreground">Prescribed On</Label>
            ...
            <div>
              ...
              <div className="bg-muted/30 rounded-lg p-4">
                <ul className="space-y-2">
                  {prescription.instructions.map((instruction, idx) => (
