...
import { Plus, MoreHorizontal, Pencil, Trash2, UserX, Mail, Phone, MapPin } from "lucide-react";
      ...
      cell: (doctor: IDoctor) => (
        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => router.push(`/admin/dashboard/doctors-management/${doctor.id}`)}
          >
    ...
    <div className="space-y-6">
      ...
      <FilterBar>
        ...
        <FilterSelect
          ...
          options={specialties.map((s) => ({ value: s.title, label: s.title }))}
