...
export default async function PatientsManagementPage({ searchParams }: PatientsManagementPageProps) {
...
async function PatientsFetcher({ searchParams }: { searchParams: { page?: string; limit?: string; searchTerm?: string } }) {
