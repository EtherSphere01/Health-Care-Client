...
import { getMyDoctorSchedules } from "@/services/doctor-schedule";
...
export default async function MySchedulesPage({ searchParams }: MySchedulesPageProps) {
...
async function SchedulesFetcher({ searchParams }: { searchParams: { page?: string; limit?: string; startDate?: string; endDate?: string } }) {
