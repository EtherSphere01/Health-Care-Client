...
export function DoctorPrescriptionsContent({
  ...
  const [viewingPrescription, setViewingPrescription] = useState<IPrescription | null>(null);
      ...
      <DialogContent className="max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>Prescribed on {formatDate(prescription.createdAt)}</span>
          </div>
          ...
          {prescription.followUpDate && (
            <div className="p-3 bg-amber-50 rounded-lg">
              <Label className="text-amber-700">Follow-up Date</Label>
