...
export async function getAllAppointments(
  ...
  return get<IAppointment[]>("/appointment", params as Record<string, unknown>, {
...
export async function getMyAppointments(
  ...
  return get<IAppointment[]>("/appointment/my-appointment", params as Record<string, unknown>, {
...
export async function updateAppointmentStatus(
  ...
  const response = await patch<IAppointment>(`/appointment/status/${appointmentId}`, data);
  revalidateTag(APPOINTMENTS_TAG);
  revalidateTag("my-appointments");
  return response;
}
