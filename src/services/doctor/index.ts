 ...
 */
export async function getDoctorById(id: string): Promise<IApiResponse<IDoctor>> {
 ...
 */
export async function getAiDoctorSuggestion(symptoms: string): Promise<IApiResponse<IAiSuggestion>> {
  return get<IAiSuggestion>("/doctor/suggestion", { symptoms }, {
    requireAuth: false,
  });
}
 ...
 */
export async function softDeleteDoctor(id: string): Promise<IApiResponse<IDoctor>> {
