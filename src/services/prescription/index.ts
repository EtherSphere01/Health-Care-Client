...
export async function getAllPrescriptions(
  ...
  return get<IPrescription[]>("/prescription", params as Record<string, unknown>, {
...
export async function getMyPrescriptions(
  ...
  return get<IPrescription[]>("/prescription/my-prescription", params as Record<string, unknown>, {
